...
from SHADECast.Models.Nowcaster.ConditionedNowcast import CAFNONowcastNet, ConditionedNowcaster, TimeEncoder, CoordEncoder
...
def train(config, distributed=True):
    ...
    time_encoder = TimeEncoder(in_dim=1,
                               out_dim=nowcaster_config['embed_dim'],
                               levels=nowcaster_config['time_levels'])
    coord_encoder = CoordEncoder(in_dim=2,
                                 levels=nowcaster_config['coord_levels'],
                                 min_ch=nowcaster_config['coord_min_ch'],
                                 max_ch=nowcaster_config['coord_max_ch'])
    ...
    nowcaster = ConditionedNowcaster(nowcast_net=nowcast_net,
...
if __name__ == '__main__':
    with open('/scratch/snx3000/acarpent/GenerativeNowcasting/Training/Nowcast_training/CondNowcastertrainingconf.yml',
              'r') as o:
